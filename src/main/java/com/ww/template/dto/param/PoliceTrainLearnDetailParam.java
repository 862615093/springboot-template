...
@Data
@ApiModel(value = "PoliceTrainLearnDetailParam对象", description = "民警培训学习详情查询入参")
public class PoliceTrainLearnDetailParam implements Serializable {

    private static final long serialVersionUID = 1L;

    @ApiModelProperty("查询类型: LEARNTIME-培训学习总时长详情, LEARNCOUNT-培训学习总学习次数详情, DOWNCOUNT-培训学习总下载次数详情")
    private TrainLearnDetailParam.SearchType searchType;
